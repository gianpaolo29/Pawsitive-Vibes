<x-admin-layout>
    <div 
        x-data="{ openModal: false, modalData: {}, expandedRow: null }"
                ...
                <table class="min-w-full text-sm divide-y divide-gray-100">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-violet-50 cursor-pointer"
                            ...
                            <td class="px-5 py-3">
                                <span class="px-3 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800 border border-yellow-200">
                                    Pending
                                </span>
                            </td>
                        ...
                        <tr x-show="expandedRow === {{ $o->id }}" 
                            ...
                            <td colspan="7" class="p-5">
                                <div class="text-sm border-l-4 border-violet-500 pl-5 bg-violet-50 rounded-lg py-3 px-4">
                                    <p class="font-semibold text-violet-800 mb-2">Order Items:</p>
                        ...
                        @empty
                            <tr><td colspan="7" class="px-5 py-5 text-center text-gray-500">No pending orders found.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
